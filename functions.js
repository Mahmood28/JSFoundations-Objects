...
function getChannelByVideoTitle(videoTitle, channels) {
  return channels.find((channel) => channel.videos.some((video) => video.title === videoTitle) === true)
}
...
function searchChannels(query, channels) {
  return channels.filter((channel) => channel.description.includes(query) === true || channel.name.includes(query) === true) 
}
